...
export const ABOUT = `I am a dedicated and versatile full stack developer
 with a passion for creating efficient and user-friendly web applications.
  With 5 years of professional experience, I have worked with a variety 
  of technologies, including React, Next.js, Node.js, MySQL, PostgreSQL, 
 ...
 solving complex problems to deliver high-quality solutions. Outside of coding,
  ...
  export const EXPERIENCE=[
    ...
    },
    {
      ...
      responsible for designing and developing a web application for inventory management.`,
